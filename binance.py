...
__URL_BASE = "https://us.binance.com/api/"
__log_enabled = False
...
class Account:
    def __init__(self, key, secret):
        ...
        If you don't have a key, log into binance.com and create one at https://us.binance.com/userCenter/createApi.html
